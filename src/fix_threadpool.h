...
#ifdef FIX_CLASS
// clang-format off
FixStyle(threadpool,FixThreadpool);
// clang-format on
#else

#ifndef LMP_FIX_THREADPOOL_H
#define LMP_FIX_THREADPOOL_H
...
class FixThreadpool : public Fix {
  // friend class ThrOMP;
  friend class ThrThreadpool;
  friend class RespaOMP;

 public:
  FixThreadpool(class LAMMPS *, int, char **);
  ~FixThreadpool() override;
